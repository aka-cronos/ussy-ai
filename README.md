...
| `prototypes/` | Prototipos desechables del panel (HTML, datos ficticios). |
| `app-macos-uso-claude-codex-cursor.md` | Borrador inicial; la especificación de [#11](https://github.com/aka-cronos/ussy-ai/issues/11) manda donde difieran. |
